...
export default function ManusQuestions() {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-foreground">質問一覧</h1>
                <p className="text-muted-foreground mt-1">あなたの質問</p>
              </div>
            </div>
            <Button asChild>
              <Link href="/manus/questions/new">
